...
then
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_loop --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE --run=scatter
    #     done
    # done
    # ##############################
    # # HPX future
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_task_sync_shared --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE
    #     done
    # done
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_task_shared --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE
    #     done
    # done
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_task_naive_shared --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE
    #     done
    # done
    # # shared agas
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_task_agas_shared --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE
    #     done
    # done
    # # scatter
    # srun -t 1:00:00 --exclusive ./build/fft_hpx_task_agas --hpx:threads=1 --nx=$BASE_SIZE --ny=$BASE_SIZE --run=scatter --header=true
    # for (( j=1; j<$LOOP; j=j+1 ))
    # do
    ...
    #     for (( j=0; j<$LOOP; j=j+1 ))
    #     do
    #         srun -t 1:00:00 --exclusive ./build/fft_hpx_task_agas --hpx:threads=$i --nx=$BASE_SIZE --ny=$BASE_SIZE --run=scatter
    #     done
    # done
    # ###############################
    # FFTW
