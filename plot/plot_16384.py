...
plt.plot(points, ss_loop_measure_shared_averaged[:,7], 's-', c=colors[2], linewidth=1, label='HPX for_loop')
# HPX loop shared data
...
# HPX loop measure shared data
plt.plot(points, ss_loop_measure_shared_averaged[:,6], 's-', c=colors[2], linewidth=1, label='HPX for_loop')
# HPX loop shared data
